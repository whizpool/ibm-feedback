...
const SnippetPageV2 = ({recordID,widgetURL}) => {
...
var codeSnippet = `<div id='ibmsnippet'><link rel="stylesheet" href="https://unpkg.com/carbon-components/css/carbon-components.min.css" >
<script src="https://unpkg.com/carbon-components/scripts/carbon-components.min.js"></script>
<script type="text/javascript" src="https://html2canvas.hertzen.com/dist/html2canvas.min.js"></script>
<link rel="stylesheet" href="${BaseURL}/inappv2.css">
<script src="https://code.jquery.com/jquery-1.11.3.min.js"></script>
<div class='feedback-box' id='feedback-box' data-html2canvas-ignore>
	<div id='widgetHTML'></div>
 </div>
</div>
<script src="${BaseURL}/inappv2.js"></script>
...
(function($) {loadFeedback();})(jQuery);</script></div>`
