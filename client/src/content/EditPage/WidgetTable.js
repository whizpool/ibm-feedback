...
import { DragVertical16 as DragVertical, Help16 as Help, Subtract24 as Subtract} from '@carbon/icons-react';
									...
									<TableRow key={rowIndex} className="widgetsRow">
										<TableCell key={rowIndex++}>
											<span>
												...
												<DragVertical className="drag-handle" draggable="false" onMouseDown={this.onMouseDown} />
											</span>
										</TableCell>
										{row.cells.map((cell) => {
